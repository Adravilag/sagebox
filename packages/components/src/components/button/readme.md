...
| -------------- | --------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------- | ----------- |
| `ariaLabel`    | `aria-label`    | Accessible label                              | `string \| undefined`                                                                             | `undefined` |
...
| `loadingText`  | `loading-text`  | Loading text (replaces content while loading) | `string \| undefined`                                                                             | `undefined` |
