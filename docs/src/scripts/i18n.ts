...
const translations: Record<Language, Record<string, any>> = {
  es: {
    ...
    about: {
      ...
      missionText: 'SagedUI fue creado para proporcionar a los desarrolladores un conjunto de componentes UI de alta calidad, accesibles y agnósticos de framework.',
      ...
      contributingText: 'SagedUI es código abierto y damos la bienvenida a contribuciones. Ya sea corrigiendo bugs, añadiendo nuevas funcionalidades o mejorando la documentación.',
      license: 'Licencia MIT',
      licenseText: 'SagedUI está liberado bajo la Licencia MIT. Puedes usarlo en proyectos personales y comerciales.',
      stats: {
        components: 'Componentes',
        typescript: 'TypeScript',
  ...
  en: {
    ...
    about: {
      ...
      mission: 'Our Mission',
      missionText: 'SagedUI was created to provide developers with a set of high-quality, accessible, and framework-agnostic UI components.',
      ...
      contributingText: 'SagedUI is open source and we welcome contributions! Whether it\'s fixing bugs, adding new features, or improving documentation.',
      license: 'MIT License',
      licenseText: 'SagedUI is released under the MIT License. You\'re free to use it in personal and commercial projects.',
      stats: {
        components: 'Components',
        typescript: 'TypeScript',
